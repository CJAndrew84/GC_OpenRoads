...
namespace Atom.BentleyOpenRoads.GenDes
{
    ...
    [GCNamespace("GenDesIFC")]
    [GCNodeTypePaletteCategory("{Gen:Des} IFC")]
    [GCNodeTypeIcon("Resources/ifc.png")]
    [GCHideInheritedTechniques]
    [GCSummary("Define and generate IFCs")]
    public class GenDesIFC : ElementBasedNode
    {
        ...
        static EECC GetEECCIfcVersion()
        {
            ...
            {
                GenDesIFC node = (GenDesIFC)parentExpressionEditor.MeaningOfThis;
